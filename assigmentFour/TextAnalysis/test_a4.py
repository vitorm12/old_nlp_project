...
class ExploreTextTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.nouns_more = cls.grail.tags_that_nouns_are_most_commonly_found_after();
        cls.greatest_word = cls.grail.which_word_has_greatest_number_of_distinct_tags()
        cls.gt = cls.grail.tags_in_order_of_decreasing_frequency()
    ...
    def test_nouns_more_common_in_plural_form(self):
        self.assertTrue(0.14 < self.ambiguous_types < 0.25)

    def test_nouns_more_common_in_plural_form(self):
        self.assertTrue(30 < len(self.nouns_more))

    def test_which_word_has_greatest_number_of_distinct_tags(self):
        self.assertTrue(self.greatest_word[0][0].isalpha())

    def test_tags_in_order_of_decreasing_frequency(self):
        self.assertTrue(len(self.gt) > 10)
